...
flow:
  ...
  inputs:
    - host: 10.0.46.10
    - username: "CAPA1\\1034-capa1user"
    - password: Automation123
    - datacenter: CAPA1 Datacenter
    - image: Ubuntu
    - folder: Students/KristenF
    - prefix_list: '1-,2-,3-'
  workflow:
    - uuid:
        do:
  ...
  graph:
    steps:
      ...
      wait_for_vm_info:
        ...
        y: 278
        navigate:
          b3b1ba10-99f5-2489-6ab4-f04e09143d33:
            targetId: 3dbe749d-4e72-8fc0-eca0-49d1055127cb
            port: SUCCESS
    results:
      SUCCESS:
        3dbe749d-4e72-8fc0-eca0-49d1055127cb:
          x: 425
          y: 341
